...
Pause to review completed rounds, reconcile your coins and consider how you will spend them. Preserve local metadata when moving installations if you want to retain more of that context. See [CoinJoin settings](settings.md) for the target, fee preferences and destination controls.
