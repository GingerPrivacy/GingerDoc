...
Start with receiving at a fresh address and understanding your existing coins. If transaction-link privacy is a concern, learn what CoinJoin can and cannot change before enabling automatic rounds. For everyday choices, continue with [Privacy habits before and after a payment](habits.md).
