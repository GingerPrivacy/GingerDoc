...
# Transaction Fees, Custom Rates and Change

> Reading level: Advanced guide. First understand the normal send preview, recipient amount and fee.

For the ordinary payment steps, start with [Send Bitcoin](send.md). This reference explains the fee controls and change in more detail; it is not necessary to choose a custom rate for every payment.
...
For selecting specific coins or handling a pending transaction, see [coin control and history](coin-control-history.md).
