...
If an order is on hold, expired, failed, or refunded, consult [Order status and selling](sell-and-orders.md). Avoid starting another purchase just because a status update is slow; first establish whether the original payment was collected.
