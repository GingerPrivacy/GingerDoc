...
## Next: receive and send

Once your backup is checked and synchronization has finished, return to [Receive a small first payment](/getting-started/#3-receive-a-small-first-payment). The next section there explains how to make your first payment.
