...
> Reading level: Advanced guide. Use the [installation guide](/getting-started/install/) to identify the official download and the package for your computer.
...
After successful verification, return to [Install the application](/getting-started/install/#install-the-application).
