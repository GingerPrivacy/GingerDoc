...
1. Download the package for your system from the official release. Check the source, version and package name, and pay attention to your operating system's signature and security checks. For independent PGP verification, use the matching `.asc` file and the separate [advanced download-verification guide](/getting-started/verify-download/) before opening the package.
...
4. Continue with [Create and open a wallet](/getting-started/first-wallet/).
...
Read the current service terms presented by Ginger before accepting them, including any eligibility restrictions. Installing the application does not establish eligibility to use every connected service.
